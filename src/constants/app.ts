...
export const SORT_OPTIONS = [
  ...
  { label: "Duração (menor)", value: "duration-asc" },
  ...
  { label: "Afinação (A-Z)", value: "tuning-asc" },
  { label: "Afinação (Z-A)", value: "tuning-desc" },
  { label: "Energia (↑)", value: "energy-desc" },
  { label: "Energia (↓)", value: "energy-asc" },
