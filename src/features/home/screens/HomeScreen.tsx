...
const PRODUCER_TAGS = [
  "Refr+�o", "Batida", "Baixo", "Melodia", "Voz", "Intro", "Drop", "Subida", "Final"
];
  ...
  const handleSearchFocus = () => {
    ...
    Animated.parallel([
      ...
      Animated.timing(searchGlowAnim, {
        ...
        duration: 220,
        easing: Easing.out(Easing.cubic),
        useNativeDriver: false, // OBRIGAT+�RIO (cor/sombra)
      }),
    ]).start();
  };
