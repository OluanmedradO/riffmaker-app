...
import { duplicateAsNewVersion, duplicateIdea, getRiffs, updateRiff } from "@/src/data/storage/riffs";
import { Project } from "@/src/domain/types/project";
import { Riff } from "@/src/domain/types/riff";
import { RiffRecorder } from "@/src/features/recorder/components/RiffRecorder";
...
import { SaveStatusIndicator } from "@/src/shared/ui/SaveStatusIndicator";
...
export function RiffDetailScreen() {
